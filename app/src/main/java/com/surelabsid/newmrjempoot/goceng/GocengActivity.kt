...
import com.surelabsid.newmrjempoot.databinding.ActivityGocengBinding
import com.surelabsid.newmrjempoot.utils.FCMType
import com.surelabsid.newmrjempoot.model.CheckStatusTransRequest
import com.surelabsid.newmrjempoot.model.DriverRequest
import com.surelabsid.newmrjempoot.model.NearbyDriverRequest
import com.surelabsid.newmrjempoot.model.RideCarRequestJson
...
class GocengActivity : BaseActivity(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityGocengBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGocengBinding.inflate(layoutInflater)
        setContentView(binding.root)

        allfiturItem = intent.getParcelableExtra(SERVICE_DATA)
...
//                        val intent = Intent(this@GocengActivity, ProgressActivity::class.java)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        binding.pickup.setText(location.get(0).getAddressLine(0))
        ...
        if (wallet.toInt() < binding.cost.cleanIntValue) {
            AlertDialog.Builder(this)
                ...
                .setPositiveButton("Topup") { d, _ ->
                    d.dismiss()
                    Intent(this@GocengActivity, WalletLandingActivity::class.java).apply {
                        startActivity(this)
                    }
                }
