package com.surelabsid.newmrjempoot.utils.api.service;
...
public class MessagingService extends FirebaseMessagingService {
    Intent intent;
    public static final String BROADCAST_ACTION = "com.surelabsid.ourjek";
...
//            chat(remoteMessage);
        } else if (Objects.requireNonNull(remoteMessage.getData().get("type")).equals("500")) {
            //promo
        } else if (Objects.requireNonNull(remoteMessage.getData().get("type")).equals("555")) {
            //all notification
        }
